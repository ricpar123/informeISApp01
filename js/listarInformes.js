...
async function fetchInformes(){
    ...
    function detalles(id){
        ...
        doc.setFontType('Oblique');
        doc.setFontSize(15);
        doc.text(12,47, 'e-mail: santiagomanuellopez@hotmail.com');
        doc.setFont('Courier');
        doc.setFontType('Oblique');
        doc.setFontSize(15);
        ...
        doc.setFontType('bold');
        doc.setFontSize(15);
        doc.text(8, 263, 'Recibido por:');
        doc.setFont('courier');
        doc.setFontType('oblique');
        doc.setFontSize(15);
        doc.text(60,263, recibido);
        doc.setFont('courier');
        doc.setFontType('bold');
        doc.setFontSize(15);
        doc.text(140, 263, 'CI nro:');
        doc.setFont('courier');
        doc.setFontType('oblique');
        doc.setFontSize(15);
        doc.text(170, 263, ci );
        ...
        doc.setFontType('bold');
        doc.setFontSize(15);
        doc.text(8, 273, 'Firma del cliente:');
        doc.setFont('courier');
        doc.setFontType('bold');
        doc.setFontSize(15);
        doc.text(140, 273, 'Fecha:');
        doc.setFont('courier');
        doc.setFontType('oblique');
        doc.setFontSize(15);
        doc.addImage(firma, 'PNG', 10, 273, 50, 20);
        doc.setFont('courier');
        doc.setFontType('oblique');
        doc.setFontSize(15);
        doc.text(160, 273, fecha);
